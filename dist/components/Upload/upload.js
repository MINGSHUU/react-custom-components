...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "viking-upload-component" },
        React.createElement("div", { className: "viking-upload-input", style: { display: 'inline-block' } },
            React.createElement(Button, { btnType: 'primary', onClick: handleClick }, drag ?
